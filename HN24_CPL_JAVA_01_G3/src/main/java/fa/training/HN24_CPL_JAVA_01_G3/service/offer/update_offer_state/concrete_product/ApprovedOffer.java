...
public class ApprovedOffer implements UpdateOfferState {
    @Override
    ...
    public void updateState(String accessToken, OfferEntity offerEntity, CandidateEntity candidateEntity) {
        OfferValidationHelper.approveValidate(offerEntity, CodeAndMessage.ERR0);
        offerEntity.setStatus(OfferStatusEnum.APPROVED.name());
        // set candidate's status to Approved Offer
        candidateEntity.setStatus(CandidateStatusEnum.STATUS_APPROVED_OFFER.getStatus());
    }
}
