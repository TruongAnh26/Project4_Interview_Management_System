...
public class CanceledOffer implements UpdateOfferState {
    @Override
    ...
    public void updateState(String accessToken, OfferEntity offerEntity, CandidateEntity candidateEntity) {
        OfferValidationHelper.cancelValidate(offerEntity, CodeAndMessage.ERR0);
        offerEntity.setStatus(OfferStatusEnum.CANCELLED.name());
        // update Candidate's state to Canceled offer
